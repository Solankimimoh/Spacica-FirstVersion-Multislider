        ...
        <div class="page-sidebar">
            ...
            <ul class="x-navigation">
                ...
                <li class="xn-openable">
                    ...
                    <ul>
                        <li>
                            <a href="home.php"><span class="fa fa-image"></span> Gallery</a>
                        </li>
                        <li>
                            <a href="imgslider.php"><span class="fa fa-image"></span>ADD Image Slider</a>
                        </li>
                        <li>
                            <a href="home.php"><span class="fa fa-image"></span>Delete Image Slider</a>
                        </li>
                    ...
                    <section class="content">
                        ...
                        <div class="box box-primary" style="margin-left:30px;margin-bottom: 70px;">
                            <div class="box-header with-border">
                                <h3 class="box-title"><b>Add a new Image in Slider</b></h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start --><br/>
                            <form method="post" enctype="multipart/form-data" action="insertslider.php">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea maxlength="100" class="form-control" name="slider_desc" rows="5" required></textarea>
                                    </div>
