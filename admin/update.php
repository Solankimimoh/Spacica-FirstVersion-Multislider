...
?>
    ...
    ?>
                <!-- META SECTION -->
                <title>Spacica | Update Product</title>
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    <li class="xn-logo"> <a href="index-2.html">Admin</a>
                        <a href="#" class="x-navigation-control"></a>
                    </li>
                    <li class="xn-profile">
                        <a href="#" class="profile-mini"> <img src="assets/images/users/avatar.jpg" alt="John Doe" /> </a>
                        <div class="profile">
                            <div class="profile-image"> <img src="assets/images/users/avatar.jpg" alt="John Doe" /> </div>
                    ...
                    <li class="xn-openable"> <a href="#"><span class="fa fa-files-o"></span> <span class="xn-text">Pages</span></a>
                        <ul>
                        ...
                        <section class="content">
                            ...
                            <div class="box box-primary" style="margin-left:30px;margin-bottom: 70px;">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><b>Update Product  Data</b></h3> </div>
                                <!-- /.box-header -->
                                <!-- form start -->
                                <br/>
                                <form method="post" enctype="multipart/form-data" action="updateimg.php">
                                    <div class="box-body">
                                        <input hidden="hidden" type="text" name="img_parent_id" value="<?php echo $pid;  ?>">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">New Product Title</label>
                                            <input type="text" name="img_name" class="form-control" id="exampleInputEmail1" placeholder="Enter Image Name" required> </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">New Product Description</label>
                                            <textarea maxlength="1800" class="form-control" placeholder="" name="img_desc" rows="5" required></textarea>
                                        </div>
                                        <div class="">
                                            <input required id="file-fr" name="file-fr[]" type="file" multiple> </div>
                                    </div>
                                    <!-- /.box-body -->
                                    <br/>
